...
public class ErrosCliente extends Cliente {
    ...
    private String erro2 = getNome() + """
            ...
            """;
    private String erro3 = getNome() + ": Minha irmã usa minha Netflix, eu vou ter que fazer um assinante extra?";
    private String erro4 = """
            Eu uso a Netflix que assinei aqui pra casa, na minha Loja,
            agora não vou poder mais usar?!
            """;
    private String erro5 = getNome() + """
            ...
            """;
    private String investigar1 = getAgente() + ": Quem é o titular da conta Netflix?";
    private String investigar2 = getAgente() + ": Mais alguém usa a sua conta Netflix?";
    private String investigar3 = getAgente() + ": Quanto tempo você pretende ficar viajando? É pra dentro do País?";
    private String investigar4 = getAgente() + ": Quais são os aparelhos em que você irá assistir?";
    private String investigar5 = getAgente() + ": Basta fazer um check-in?";
    private String investigar6 = getAgente() + ": Em que aparelhos você e sua irmã usam a Netflix?";
    private String investigar7 = getAgente() + ": me fala em quais aparelhos ela(e) assiste.";
    private String investigar8 = getAgente() + ": Ela vai ter que fazer um assinante extra.";

    private String resolucao1de1 = getAgente() + ":Sua mãe deve ter definido o endereço dela como sendo o principal da conta.";

    private String residenciaNetflix = getAgente() + ": Foi colocado em outra Smart TV como sendo a Residencia Netflix, por isso que você não consegue acessar.";
    private String resolucaoResidencia = getAgente() + ": Só precisamos colocar sua SMART-TV como Localização principal na Residência Netflix (KB 128777).";
    private String assinanteExtra = getAgente() + ": podemos criar um assinante extra. (KB 124633)";
    private String localizacaoPrincipal = getAgente() + ": Posso ajudar você a definir sua localização principal.";
    private String checkIn = getAgente() + """
    ...
    private String assinanteExtraExplicacao = getAgente() + """
    ...
    private String encerramento = getAgente() + """
    ...
    public void setRespostaAgente() {
        ...
        if (respostaAgente == 1) {
           this.respostaAgente = 1;
            ...
            System.out.println("Pequeno padawan, encontramos um erro na FORÇA! Recarregue a aplicação...");
        }
    }
